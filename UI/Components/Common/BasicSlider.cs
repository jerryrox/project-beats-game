...
namespace PBGame.UI.Components.Common
{
        ...
        IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void Init(IColorPreset colorPreset)
        {
            ...
            background.Depth = -1;
            background.Height = 16f;
            background.SpriteName = "circle-16";
