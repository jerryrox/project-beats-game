...
{
    public class PrimaryTouchEffects : TouchEffect, IRecyclable<PrimaryTouchEffects> {
        ...
        private void Init()
        {
            ...
            {
                glowSprite.Size = new Vector2(128f, 128f);
            ...
            fillSprite = CreateChild<UguiSprite>("fill");
            {
                ...
                fillSprite.Color = ColorPreset.PrimaryFocus;
